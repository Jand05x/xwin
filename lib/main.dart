...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/welcome': (context) => WelcomeScreen(),  // Landing page with login/signup buttons
        '/login': (context) => LoginScreen(),  // User login page
        '/register': (context) => RegistrationScreen(),  // New donor registration
        '/home': (context) => HomeNavigation(),  // Main screen with bottom navigation
        ...
        '/hospital_dashboard': (context) => HospitalDashboardScreen(),  // Hospital management
        '/verify': (context) => VerificationQueueScreen(),  // Admin verification queue
        '/learn': (context) => LearnAboutDonationScreen(),  // Educational articles
        '/change_password': (context) => ChangePasswordScreen(),  // Change password
      },
    );
  }
}